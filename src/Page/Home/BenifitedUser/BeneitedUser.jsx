    ...
    <div className="lg:h-[70vh] bg-blue-900 py-7 px-8 w-11/12 mx-auto my-6">
      <div className="grid lg:grid-cols-3 grid-cols-1 h-11/12 my-auto gap-4">
        ...
        >
          ...
          <div className="flex items-center pr-4">
            <h3 className="text-left text-sm">
              Great task manager! The user interface is intuitive, and it helps
              me stay organized efficiently.
            </h3>
          </div>
        </div>
        <div
        ...
        >
          <div className="flex flex-col justify-center items-center">
            ...
            <h3>Robert Smith</h3>
            <h3 className="text-blue-900 font-semibold">Student</h3>
          </div>
          <div className="flex items-center pr-4">
            <h3 className="text-left text-sm">
        ...
        >
          <div className="flex flex-col justify-center items-center">
            ...
            <h3>Sirin Jaman</h3>
            <h3 className="text-blue-900 font-semibold">Software Engineer</h3>
          </div>
          <div className="flex items-center pr-4">
            <h3 className="text-left text-sm">
